...
namespace Guide.Infrastructure.Messaging.RabbitMQ
{
    public class RabbitMqEventSubscriber : IEventSubscriber
    {
        ...
        public void Subscribe<T>(T domainEvent) where T : IEvent
        {
            this._channel.QueueDeclare(queue: domainEvent.EventKey, durable: true, exclusive: false, autoDelete: false,
                arguments: null);
            ...
            _channel.BasicConsume(queue: domainEvent.EventKey, autoAck: false, consumer: consumer);
        }
